...
if ($info) {
   ...
   $exam_type     = mysqli_real_escape_string($conn, $info->exam_type);
    ...
    if ($btn_name == "Insert") {
    $query2="SELECT * FROM marks WHERE rollno='$rollno' AND sc='VI' AND exam_type='$exam_type'";
    $result2=mysqli_query($conn,$query2);
    if(mysqli_num_rows($result2)>0){
        echo 'Already Exists';
    }else{
        $query = "INSERT INTO marks(rollno,sc,co,sec,exam_type,s1,sc1,s2,sc2,s3,sc3,s4,sc4,s5,sc5,s6,sc6,s7,sc7,s8,sc8,s9,sc9,s10,sc10) VALUES ('$rollno','VI','$b','$c','$exam_type','$s1','$sc1','$s2','$sc2','$s3','$sc3','$s4','$sc4','$s5','$sc5','$s6','$sc6','$s7','$sc7','$s8','$sc8','$s9','$sc9','$s10','$sc10')";
    ...
    if ($btn_name == 'Update') {
        $mid    = $info->mid;
        $query = "UPDATE marks SET mid='$mid',rollno='$rollno',sc='VI', co='$b' ,sec='$c',exam_type='$exam_type', s1='$s1', sc1='$sc1', s2='$s2', sc2='$sc2', s3='$s3', sc3='$sc3', s4='$s4', sc4='$sc4', s5='$s5', sc5='$sc5', s6='$s6', sc6='$sc6', s7='$s7', sc7='$sc7', s8='$s8', sc8='$sc8', s9='$s9', sc9='$sc9', s10='$s10', sc10='$sc10' WHERE mid = '$mid'";
        if (mysqli_query($conn, $query)) {
