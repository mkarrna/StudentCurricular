...
if ($info) {
    ...
    if ($btn_name == "Insert") {
        $query = "INSERT INTO de_notices(dept,ad_date,notice,rem_date) VALUES ('BSC','$ad_date', '$notice', '$rem_date')";
    ...
    if ($btn_name == 'Update') {
        ...
        $query = "UPDATE de_notices SET  dept = 'BSC', ad_date = '$ad_date', notice = '$notice', rem_date = '$rem_date' WHERE notice_no = '$notice_no'";
        if (mysqli_query($conn, $query)) {
