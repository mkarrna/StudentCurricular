...
session_start();
    ...
    if ($btn_name == "Insert") {
        $query2="SELECT * FROM at1 WHERE rollno='$rollno' AND sc='III' AND month='$month'";
    $result2=mysqli_query($conn,$query2);
    if(mysqli_num_rows($result2)>0){
        echo 'Already Exists';
    }else{
        $query = "INSERT INTO at1(rollno,sc,co,sec,month,s1,ac1,s2,ac2,s3,ac3,s4,ac4,s5,ac5,s6,ac6,s7,ac7,s8,ac8,s9,ac9,s10,ac10) VALUES ('$rollno','III','$b','$c','$month','$s1', '$ac1','$s2', '$ac2','$s3', '$ac3','$s4', '$ac4','$s5', '$ac5','$s6', '$ac6','$s7', '$ac7','$s8', '$ac8','$s9', '$ac9','$s10', '$ac10')";
    ...
    if ($btn_name == 'Update') {
        $aid    = $info->aid;
        $query = "UPDATE at1 SET aid='$aid',rollno='$rollno',sc='III', co='$b' ,sec='$c',month='$month', s1='$s1', ac1='$ac1', s2='$s2', ac2='$ac2', s3='$s3', ac3='$ac3', s4='$s4', ac4='$ac4', s5='$s5', ac5='$ac5', s6='$s6', ac6='$ac6', s7='$s7', ac7='$ac7', s8='$s8', ac8='$ac8', s9='$s9', ac9='$ac9', s10='$s10', ac10='$ac10' WHERE aid = '$aid'";
        if (mysqli_query($conn, $query)) {
