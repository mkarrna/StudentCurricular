...
if ($info) {
    ...
    if ($btn_name == "Insert") {
        $query = "INSERT INTO m3(rollno,co,sec,s1,m1,s2,m2,s3,m3,s4,m4,s5,m5,s6,m6,s7,m7,s8,m8) VALUES ('$rollno','$co','$sec','$s1', '$m1','$s2', '$m2','$s3', '$m3','$s4', '$m4','$s5', '$m5','$s6', '$m6','$s7', '$m7','$s8', '$m8')";
    ...
    if ($btn_name == 'Update') {
        $rollno    = $info->rollno;
        $query = "UPDATE m3 SET rollno='$rollno',co='$co',sec='$sec', s1='$s1', m1='$m1', s2='$s2', m2='$m2', s3='$s3', m3='$m3', s4='$s4', m4='$m4', s5='$s5', m5='$m5', s6='$s6', m6='$m6', s7='$s7', m7='$m7', s8='$s8', m8='$m8' WHERE rollno = '$rollno'";
        if (mysqli_query($conn, $query)) {
